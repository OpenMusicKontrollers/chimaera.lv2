...
state_save(LV2_Handle instance, LV2_State_Store_Function store, LV2_State_handle_t state, uint32_t flags, const LV2_Feature *const *features)
{
...
static LV2_State_Status
state_restore(LV2_Handle instance, LV2_State_Retrieve_Function retrieve, LV2_State_handle_t state, uint32_t flags, const LV2_Feature *const *features)
{
	handle_t *handle = (handle_t *)instance;
